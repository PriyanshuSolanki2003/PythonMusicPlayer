...
canvas.geometry("1000x1800")
canvas.config(bg='black')

rootpath="C:\\Music Player\Music"
pattern ="*.mp3"
...
listBox=tk.Listbox(canvas, fg="cyan", bg="black",width=100, font=('Times New Roman', 18) )
listBox.pack(padx=15, pady=15)

label=tk.Label(canvas, text='', bg='black', fg='yellow', font=('Times New Roman',18))
label.pack(pady=15)
